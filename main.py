...
if __name__ == "__main__":
    ...
    colors = np.unique(np.asarray(color_thief.get_palette(color_count=4, quality=10), dtype=np.int64), axis=0)
    # colors = np.array([ [255, 255, 255], [255, 0, 0], [0, 255, 0], [0, 0, 255], [255, 255, 0], [0, 255, 255],
    #                  [255, 0, 255]])

    area_collector = AreaCollector(image_array, colors, 100)
    ...
    area_collector.save_svg_with_all_contours('./data/out/all_contours.svg')
